...
export class DiagnosticsManager {
	 ...
	 */
	public async getProblems(uri: vscode.Uri): Promise<{ errors: number, warnings: number, infos: number, hints: number }> {
	 ...
	 */
	public getProblemsText(problems: { errors: number, warnings: number, infos: number, hints: number }): string {
